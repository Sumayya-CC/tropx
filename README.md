...
* Discount coupons — code-based percentage/fixed discounts with stacking rules, usage limits (global and per-customer), minimum-order and date-window eligibility, and a live preview against orders in both the admin order form and the customer portal cart
