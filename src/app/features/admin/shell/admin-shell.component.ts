  ...
  sections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Shops', route: '/admin/shops', permission: 'manageShops', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l1-5h16l1 5"></path><path d="M4 9v10a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9"></path><path d="M9 22V12h6v10"></path></svg>') },
        { label: 'Pipeline', route: '/admin/pipeline', permission: 'manageShops', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" y1="6" x2="20" y2="6"></line><line x1="4" y1="12" x2="14" y2="12"></line><line x1="4" y1="18" x2="8" y2="18"></line></svg>') },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Coupons', route: '/admin/coupons', permission: 'manageCoupons', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>') }
      ]
    },
    {
      label: 'INVENTORY',
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Bills', route: '/admin/bills', permission: 'viewReports', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>') }
      ]
    },
    {
      label: 'FINANCE',
      items: [
        { label: 'Money Out', route: '/admin/money-out', permission: 'viewReports', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>') },
        { label: 'Expenses', route: '/admin/expenses', permission: 'viewReports', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>') }
      ]
    },
    {
      label: 'ADMIN',
      items: [
        ...
        { label: 'Reconciliation', route: '/admin/reconciliation', permission: 'manageSettings', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="3" x2="12" y2="21"></line><path d="M3 9l9-6 9 6"></path><path d="M9 21h6"></path><path d="M5 9v12"></path><path d="M19 9v12"></path></svg>') },
        ...
        { label: 'Banner Clicks', route: '/admin/banner-clicks', permission: 'manageSettings', icon: this.svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>') }
      ]
    }
  ];
